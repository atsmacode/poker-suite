...
enum Card: int
{
    ...
    public function toArray(): array
    {
        return match ($this) {
            ...
            self::TC  => array_merge(['id' => 10], Rank::TEN->toArray(),   Suit::CLUBS->toArray()),
            ...
            self::TD  => array_merge(['id' => 23], Rank::TEN->toArray(),   Suit::DIAMONDS->toArray()),
            ...
            self::TH  => array_merge(['id' => 36], Rank::TEN->toArray(),   Suit::HEARTS->toArray()),
            ...
            self::TS  => array_merge(['id' => 49], Rank::TEN->toArray(),   Suit::SPADES->toArray()),
